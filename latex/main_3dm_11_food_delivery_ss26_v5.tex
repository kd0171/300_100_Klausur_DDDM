...
\vspace{0.5cm}
{\Large Lecture 11 - Platform-based Food Delivery - 日本語訳・詳細解説・試験対策ノート\par}
\vspace{1cm}
...
\end{minipage}
\vfill
{\large Materials/2026/3DM\_11\_Food-Delivery\_SS26.pdf}
\end{titlepage}
\tableofcontents
\clearpage
\input{sections/3dm_11_food_delivery_ss26_v5.tex}
\end{document}
