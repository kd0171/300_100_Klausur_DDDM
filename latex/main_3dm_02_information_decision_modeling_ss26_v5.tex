...
\vspace{0.5cm}
{\Large Lecture 2 - Information and Decision Modeling - 日本語訳・詳細解説・試験対策ノート\par}
\vspace{1cm}
...
\end{minipage}
\vfill
{\large Materials/2026/3DM\_02\_Information-and-Decision-Modeling\_SS26.pdf}
\end{titlepage}
\tableofcontents
\clearpage
\input{sections/3dm_02_information_decision_modeling_ss26_v5.tex}
\end{document}
