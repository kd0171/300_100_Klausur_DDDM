...
\vspace{0.5cm}
{\Large Lecture 7 - Look-ahead Methods - 日本語訳・詳細解説・試験対策ノート\par}
\vspace{1cm}
...
\end{minipage}
\vfill
{\large Materials/2026/3DM\_07\_Lookahead-Methods\_SS26.pdf}
\end{titlepage}
\tableofcontents
\clearpage
\input{sections/3dm_07_lookahead_methods_ss26_v5.tex}
\end{document}
